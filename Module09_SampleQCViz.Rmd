...
![](.images/PCAplot_Fancy_rlog_ko.Tx.pdf){width=75%}

In this plot of our data, similar to what we'll generate below, principle component 1 (PC1) explains ~80% of the variance in our data while principle component 2 (PC2) explains ~12% of the variance. 
