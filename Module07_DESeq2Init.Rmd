...
![](./images/wayfinder_07.png){width=75%}
...
**Checkpoint**: *If you see `MetaInfo` in your environment panel, please indicate with the green 'check' button. Otherwise, please use the grey 'slow down' button to have the command repeated*
...
**Checkpoint**: *If you see `dds` in your environment panel, please indicate with the green 'check' button. Otherwise, please use  use the grey 'slow down' button in your zoom reaction panel to have this step repeated. You can use the red 'x' to be put in a breakout room for help*
...
<details>
    <summary>*Click for how to add a covariate to sample information*</summary>
