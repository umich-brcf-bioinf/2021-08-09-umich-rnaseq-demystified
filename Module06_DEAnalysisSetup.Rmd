...
* If you've run a qPCR assay and enjoyed all the pippeting, put up a green check. If you've run a qPCR assay and needed some time away from the multichannels, put up a grey slow down button. 
* If cloning a gene reporter (ie: promoter + GFP), worked for you the first time, put up a green check. If you have a freezer box full of cloning attempts, put up a grey slow down button.  
* If you are ready to learn about bioinformatic tools for comparing gene expression, put up a green check. If you have some questions about the materials covered yesterday or covered in the webinar, put a grey slow down button.  
...
getwd()
```
**Checkpoint**: *Please use the `grey slow down` button in your zoom reaction panel if you are not in your own '2021-08-09-umich-rnaseq-demystified' directory after executing the `getwd()` commands.*
...
**Checkpoint**: *Please use the 'green check' if you see 'data' within your '2021-08-09-umich-rnaseq-demystified' directory and use the 'grey slow down' button in your zoom reaction panel if you'd like the steps repeated*
...
While your data downloads, as discussed in [Software Carpentry](https://umcarpentries.org/intro-curriculum-r/) and other forums, including a review by [Nobel, 2009](https://journals.plos.org/ploscompbiol/article?id=10.1371/journal.pcbi.1000424), file organization is an important part of reproducible research. 
...
R/Rstudio has a strong community component so if you are getting an error or wondering how to make a command work or how to perform a specific task, there is likely already a solution out there. Remember that Google is your friend, although sometimes it can be a challenge to figure out *what to search for*. Key parts of a successful search:
