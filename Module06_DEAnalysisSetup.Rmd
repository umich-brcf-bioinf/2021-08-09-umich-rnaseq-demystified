...
getwd()
```
**Checkpoint**: *Please use the red 'x' button in your zoom reaction panel if you are not in your own '2021-08-09-umich-rnaseq-demystified' directory after executing the `getwd()` commands.*
